    ...
    <title></title>
		...
		<script>
			...
			function ajaxGet() {
				 ...
				 xmlhttp.open("GET","AJAX/add2cart.php?pid="+pid+"&qty="+qty,true);
				 xmlhttp.send();
			}
  	...
  	<main role="main" class="container" id="main">
			<div class="starter-container">
				<div style="clear:both;">
					Product ID: <input id="pid" type="text">
					Quantity: <input id="qty" type="text">
				</div>
				<input type="button" value="Add to cart" onclick="ajaxGet();" style="margin : 5px;">
